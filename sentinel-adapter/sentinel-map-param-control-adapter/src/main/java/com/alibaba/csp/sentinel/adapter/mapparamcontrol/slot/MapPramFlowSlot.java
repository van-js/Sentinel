 ...
 */
@Spi(order = -4500)
public class MapPramFlowSlot extends AbstractLinkedProcessorSlot<DefaultNode> {
    ...
    private void checkGatewayParamFlow(ResourceWrapper resourceWrapper, int count, Object... args)
        ...
        List<ParamFlowRule> rules = MapPramRuleManager.getConvertedParamRules(resourceWrapper.getName());
